...
function run(filter) {
	...
	for (i = 0; i < movies.length; i++) { 
		...
		poster.setAttribute("src", "documentaries/" + movies[i] + ".jpg");
		posterCon.appendChild(poster);
	}
	docsSrc();
	racingExtinction.setAttribute("class", "poster 2015 documentary action adventure");
	jiroDreamsOfSushi.setAttribute("class", "poster 2011 pg documentary");
	chasingIce.setAttribute("class", "poster 2012 pg13 documentary biography");
...
var docCount = movies.length +  " Documentaries";

var sortTitle = document.createElement("p");
sortTitle.setAttribute("id", "sortTitle");
sortTitle.setAttribute("class", "sortTitle subFilterTitles docSortTitle");
var sortTT = document.createTextNode("Sort by " + docCount);
...
var rMovieButtonText = document.createTextNode("Random Documentary");
...
var docFlicksJS = document.createElement("script");
docFlicksJS.setAttribute("async", "true");
docFlicksJS.setAttribute("src", "javascript/docFlicks.js");
document.head.appendChild(docFlicksJS);
